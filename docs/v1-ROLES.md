...
- **After adding features or rules:** Verify public docs reflect the new capabilities. "60 rules" not "51." "Community libraries: full support" not "limited."
...
| 50. Component search mandatory | | **S** | | **P** | | |
| 51. Phase 5 enforced | | | | | **P** | **P** |
...
Rule 50 is component search enforcement — DS Integration Engineer owns (Phase 1), Build Engineer supports.
Rule 51 is Phase 5 structural enforcement — Learning Engineer and Product QA own (Phase 5).
